              ...
              {tags
                ...
                .map((tag) => (
                  <Link href={`/blog/tag/${tag}`} key={tag}>
                    <a className="inline-block text-sm font-bold mr-2 mb-2 transform duration-200 text-cyan-800 bg-cyan-100 hover:bg-cyan-200  rounded-md px-2 py-1">
                      {tag}
                    </a>
                  </Link>
                ))}
                ...
                .map((post) => (
                  <li key={post.id}>
                    <Link href={`/blog/post/${post.slug}`}>
                      <a className="text-gray-100 hover:text-cyan-600   font-bold text-lg leading-10 transition-colors">
                        {post.name}
                      </a>
                    </Link>
                  </li>
